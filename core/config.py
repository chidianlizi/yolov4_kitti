...
__C.YOLO.CLASSES              = "./training/kitti.names"
...
# Train options
__C.TRAIN                     = edict()
# __C.TRAIN.ANNOT_PATH           = "./training/kitti_train_set.txt"
__C.TRAIN.FILE_PATH           = "./training/kitti_tfrecords/train.tfrecord"
__C.TRAIN.BATCH_SIZE          = 1
# __C.TRAIN.INPUT_SIZE            = [320, 352, 384, 416, 448, 480, 512, 544, 576, 608]
__C.TRAIN.SAMPLES             = 5236
__C.TRAIN.INPUT_SIZE          = 416
__C.TRAIN.DATA_AUG            = True
__C.TRAIN.LR_INIT             = 1e-5
__C.TRAIN.LR_END              = 1e-6
__C.TRAIN.WARMUP_EPOCHS       = 2
__C.TRAIN.FISRT_STAGE_EPOCHS  = 25
