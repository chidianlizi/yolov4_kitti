...
def compute_loss(pred, conv, label, bboxes, STRIDES, NUM_CLASS, IOU_LOSS_THRESH, i=0):
    ...
    # if output_size==52:
        # print("-------------conv_raw_conf------------------")
        # print(conv_raw_conf[0][0])
        # print("-------------conv_raw_prob------------------")
        # print(conv_raw_prob[0][0])
        # print("-------------pred_xywh[10][10]------------------")
        # print(np.array(pred_xywh[0][10][10]))
        # print("-------------pred_xywh[26][24]------------------")
        # print(np.array(pred_xywh[0][26][24]))
        # print("-------------pred_conf[10][10]------------------")
        # print(np.array(pred_conf[0][10][10]))
        # print("-------------pred_conf[26][24]------------------")
        # print(np.array(pred_conf[0][26][24]))
        # print("-------------pred_conf------------------")
        # print(pred_conf[0][0])
        # print("-------------label[10][10]------------------")
        # print(np.array(label_xywh[0][10][10]))
        # print("-------------label[26][24]------------------")
        # print(np.array(label_xywh[0][26][24]))
        # print("-------------label[10][10]------------------")
        # print(np.array(respond_bbox[0][10][10]))
        # print("-------------label[26][24]------------------")
        # print(np.array(respond_bbox[0][26][24]))
        # print("-------------respond_bbox------------------")
        # print(respond_bbox[0][np.nonzero(respond_bbox[0])])
        # print("-------------label_prob------------------")
        # print(label_prob[0][np.nonzero(label_prob[0])])
